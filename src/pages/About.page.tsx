export default function AboutPage() {
  return (
    <article>
      ...
      <ul className="mb-3">
        <li><a className="color-keyword" href="" target="_blank">Client (React, Typescript, Tailwind)</a></li>
        <li><a className="color-keyword" href="" target="_blank">Server (Express, Typescript)</a></li>
      </ul>
